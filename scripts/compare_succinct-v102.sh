...
# The addresses in addresses/succinct-v102.json are for the pre-deployed contracts on mainnet.
...
echo "  - OPSuccinctFaultDisputeGame: 0xc5bd131ceaeb72f15c66418bc2668332ab99de37"
echo ""
...
./scripts/compare_release.sh addresses/succinct-v102.json $FORGE_ARTIFACTS_DIR
